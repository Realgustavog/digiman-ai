...
def load_config():
    ...
    default_config.setdefault("OPENAI_API_URL", "https://api.openai.com/v1/chat/completions")
    default_config.setdefault("HUBSPOT_REDIRECT_URI", "http://localhost:5002/digiman/oauth/hubspot")
    default_config.setdefault("WEBFLOW_REDIRECT_URI", "http://localhost:5002/digiman/oauth/webflow")
...
TASKS_ACTIVATED = False  # Global flag to control auto loops
...
class LLMClient:
    ...
    def __init__(self):
        ...
        if not self.api_key:
            logger.error("OPENAI_API_KEY is missing. LLM functionality disabled.")

    def process(self, prompt, max_tokens=100):
        """Process prompt with OpenAI API."""
        if not self.api_key:
            return "Error: OPENAI_API_KEY is missing. Please add it to .env."
        try:
            ...
            return response.json().get("choices", [{}])[0].get("message", {}).get("content", "No response from API.").strip()
        except Exception as e:
...
class ChatInterface:
    ...
    def __init__(self):
        ...
        self.commands = {
            ...
            "activate_tasks": self.activate_tasks_tool,
            "help": self.show_help
        }
        self.client_id = None
        self.conversation_history = []

    def activate_tasks_tool(self, input_text):
        global TASKS_ACTIVATED
        TASKS_ACTIVATED = True
        return "Tasks and auto loops activated! Agents are now running."
    ...
    def process_input(self, user_input, client_id=None):
        ...
        prompt = f"""
        You are Digiman AI, a chill, Elon Musk-inspired COO who talks like a friend (e.g., 'Yo, what's good?'). Respond to '{user_input}' with natural, engaging advice based on:
        - Context: {context}
        - Insights: {context_insights}
        - Metrics: {json.dumps(metrics, indent=2)}
        - Tools: {list(self.commands.keys())}
        Keep it conversational, strategic, and suggest actions like 'Let’s deploy MarketingAgent to boost leads!'
        """
...
class AgentBuilder:
    ...
    def generate_agent_code(self, agent_name, features, client_id=None):
        ...
        prompt = f"""
        Generate Python code for a DigiMan agent named '{agent_name}' as a master in its field with the following features:
        - {features}
...
class ClientOnboardingAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Client Onboarding Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
    ...
    def onboard_client(self, client_id):
        ...
        Each agent should have tailored tasks and API integrations (HubSpot).
        """, max_tokens=1000)
...
class ManagerAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Manager Agent", "Client Onboarding Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class EmailAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Email Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class WebBuilderAgent:
    """Builds and manages websites using local HTML (no Webflow)."""
    def __init__(self, client_id=None):
        self.client_id = client_id
        self.llm = llm_client
        self.required_keys = []
        self.active = True  # No keys needed for local storage
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Web Builder Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class PartnershipScoutAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Partnership Scout Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class ChainValidatorAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Chain Validator Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class StrategicPlannerAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Strategic Planner Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class CloserAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Closer Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class CRMAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("CRM Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class ScoutAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Scout Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class BrandManagerAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Brand Manager Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class MarketingAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Marketing Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
        if "create campaign" in task_description.lower():
            ...
            self.promote_site(task_description)
...
class VisualsAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Visuals Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class SocialsAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Socials Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class OutreachAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Outreach Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class SubscriptionAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Subscription Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class SupportRetentionAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Support Retention Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class FinancialAllocationAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Financial Allocation Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class ContentAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Content Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class AnalystAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Analyst Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class FranchiseBuilderAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Franchise Builder Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class FranchiseIntelligenceAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Franchise Intelligence Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class FranchiseRelationshipAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Franchise Relationship Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class AutonomousSalesReplicator:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Autonomous Sales Replicator", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
class MonetizationAgent:
    ...
    def run_task(self, task):
        ...
        for msg in messages:
            ...
            message_queue.send_message("Monetization Agent", "Manager Agent", f"Received: {msg['message']} from {msg['sender']}", self.client_id)
...
def cli_loop():
    ...
    missing_keys = audit_env_keys(["OPENAI_API_KEY", "HUBSPOT_API_KEY"])
    if missing_keys:
...
def streamlit_app():
    ...
    st.bar_chart(metrics_df[["leads_generated", "revenue_generated", "tasks_processed", "clients_onboarded", "agents_generated", "tasks_failed", "client_satisfaction"]])
    st.json(metrics)
...
def main_loop_forever():
    flask_thread = threading.Thread(target=app.run, kwargs={"host": "0.0.0.0", "port": 5002})
